...
int main() {
    ...
    std::cout << "Expected speedup vs serial: 1.5x to 3.5x for deeper trees" << std::endl;
    std::cout << "Expected time ranges:" << std::endl;
    std::cout << "  Depth 1-5: 0.5-30ms (faster than serial)" << std::endl;
    std::cout << "  Depth 6-12: 5-300ms (faster than serial)" << std::endl;
    std::cout << "  Depth 15-20: 20-1000ms (faster than serial)" << std::endl;
